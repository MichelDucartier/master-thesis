...
\begin{figure}[t]
    ...
    \begin{tcolorbox}[colback=blue!5, title=Prompt, width=0.3\textwidth, fonttitle=\bfseries]
        \centering
...
\begin{figure}[t]
    \centering
    \begin{tcolorbox}[colback=blue!5, title=Prompt, width=0.45\textwidth, fonttitle=\bfseries]
