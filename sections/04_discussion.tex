...
% Second, the modality-driven encoders rely on predefined modality categories and assume accurate modality assignment during training and inference. Errors or ambiguity in modality labeling may reduce the effectiveness of expert specialization.
