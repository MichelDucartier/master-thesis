...
To address these challenges, we introduce MultiMeditron, a robust pipeline following the LLaVA architecture, which emphasizes extensibility across multiple modalities, clean code, thorough documentation, and reproducible settings.

Our goal is twofold. First, we aim at building a reproducible framework for AI research that integrates modular, scalable pipelines and transparent practices with fully open datasets and training code. Second, we present a first suite of multimodal medical models that highlights the capabilities of the MultiMeditron framework.
...
\begin{center}
    \includegraphics[width=0.8\textwidth]{images/multimeditron_logo.png}
\end{center}
...
%     width=0.9\textwidth,
% caption={\center Overview of the \textbf{MultiMeditron} framework featuring two different image embedders: a single-expert embedder and a modality-driven embedder}  % Fill the caption here
